<?php namespace App\Repositories\Core\Access\Role;
...
class EloquentRoleRepository implements RoleRepositoryContract
{
     ...
     */
    public function findOrFail($id, $withPermissions = false)
    {
     ...
     * @return mixed
     */
    public function getRolesPaginated($per_page = 20, $order_by = 'sort', $sort = 'asc')
    {
