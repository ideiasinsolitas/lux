<?php namespace App\Repositories\Core\Access\User;

use App\Models\Access\User\User;
use App\Exceptions\GeneralException;
use App\Repositories\Core\Access\Role\RoleRepositoryContract;
use App\Repositories\Front\Access\Auth\AuthenticationContract;
use App\Exceptions\Core\Access\User\UserNeedsRolesException;
...
class EloquentUserRepository implements UserContract
{
     ...
     * @return mixed
     */
    public function getUsersPaginated($per_page = 20, $status = 1, $order_by = 'id', $sort = 'asc')
    {
     ...
     */
    public function getDeletedUsersPaginated($per_page = 20)
    {
