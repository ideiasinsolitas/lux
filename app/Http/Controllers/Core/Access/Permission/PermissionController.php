...
use App\Http\Requests\Core\Access\Permission\EditPermissionRequest;
use App\Http\Requests\Core\Access\Permission\StorePermissionRequest;
use App\Http\Requests\Core\Access\Permission\CreatePermissionRequest;
use App\Http\Requests\Core\Access\Permission\UpdatePermissionRequest;
use App\Http\Requests\Core\Access\Permission\DeletePermissionRequest;
...
class PermissionController extends Controller
{
    ...
    {
        $permission = $this->permissions->findOrFail($id, true);
