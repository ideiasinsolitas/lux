<?php namespace App\Http\Controllers\Core\Access\User;

use App\Http\Controllers\Controller;
use App\Repositories\Core\User\UserContract;
use App\Repositories\Core\Access\Role\RoleRepositoryContract;
use App\Repositories\Front\Auth\AuthenticationContract;
use App\Repositories\Core\Permission\PermissionRepositoryContract;
use App\Http\Requests\Core\Access\User\CreateUserRequest;
use App\Http\Requests\Core\Access\User\StoreUserRequest;
use App\Http\Requests\Core\Access\User\EditUserRequest;
use App\Http\Requests\Core\Access\User\MarkUserRequest;
use App\Http\Requests\Core\Access\User\UpdateUserRequest;
use App\Http\Requests\Core\Access\User\DeleteUserRequest;
use App\Http\Requests\Core\Access\User\RestoreUserRequest;
use App\Http\Requests\Core\Access\User\ChangeUserPasswordRequest;
use App\Http\Requests\Core\Access\User\UpdateUserPasswordRequest;
use App\Http\Requests\Core\Access\User\PermanentlyDeleteUserRequest;
use App\Http\Requests\Core\Access\User\ResendConfirmationEmailRequest;
...
class UserController extends Controller
{
    ...
    {
        $user = $this->users->findOrFail($id, true);
