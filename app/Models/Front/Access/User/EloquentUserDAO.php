<?php namespace App\Repositories\Access\Front\User;
...
use App\Repositories\Core\Access\Role\RoleDAOContract;

/**
 * Class EloquentUserDAO
 * @package App\Repositories\User
 */
class EloquentUserDAO implements UserContract
{
    ...
    /**
     * @param RoleDAOContract $role
     */
    public function __construct(RoleDAOContract $role)
    {
        $this->role = $role;
    }
    ...
    public function sendConfirmationEmail($user)
    {
        ...
        return Mail::send('emails.confirm', ['token' => $user->confirmation_code], function ($message) {
            use ($user)
