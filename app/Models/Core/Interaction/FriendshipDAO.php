...
use App\Repositories\Core\Interaction\Actions\FriendshipAction;
use App\Repositories\Core\Interaction\Relationships\FriendshipRelationship;

class FriendshipDAO extends DAO
{
    use FriendshipAction,
    ...
    public function __construct()
    {
        ...
        parent::__construct('core_friendships', 'Friendship', $filters);
    }
